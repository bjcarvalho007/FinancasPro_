...
export const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    excelenteResultado: '💎 ¡Excelente resultado!',
    sobrouText: 'Sobra',
    livreBolsoText: 'libre en tu bolsillo tras el pago de los gastos planificados de este mes. Mantuviste un excelente control del dinero en',
    atencaoGastoAlto: '🚨 Atención (Gasto un poco alto):',
    superaramDinheiro: 'Tus gastos y facturas superaron el dinero disponible este mes en',
    recomendamosPriorizar: 'Por el momento gastaste más de lo ingresado. Recomendamos priorizar gastos básicos y evitar compras extra hasta equilibrar el saldo.',
    cuidadoPesoParcelas: '⚠️ Cuidado con el peso de las cuotas:',
    parcelamentosComprometem: 'Tus pagos en cuotas comprometen el',
    historicoFinanceiroText: 'de tu historial financiero',
    eviteNovosParcelamentos: '¡Muchas compras en cuotas atan tus ingresos futuros. Evita nuevos aplazamientos hasta reducir este porcentaje!',
  ...
  en: {
    ...
    sobrouText: 'Leftover',
    livreBolsoText: "free in your pocket after paying this month's planned expenses. You maintained great money control in",
    atencaoGastoAlto: '🚨 Warning (Expense slightly high):',
    superaramDinheiro: 'Your expenses and bills exceeded your available money this month by',
    recomendamosPriorizar: 'At the moment you spent more than you earned. We recommend prioritizing basic bills and avoiding extra purchases until balanced.',
    cuidadoPesoParcelas: '⚠️ Be careful with installment weight:',
    parcelamentosComprometem: 'Your card installments commit',
  ...
  fr: {
    ...
    sobrouText: 'Reste',
    livreBolsoText: 'libre dans votre poche après le paiement des dépenses prévues pour ce mois. Vous avez gardé un excellent contrôle en',
    atencaoGastoAlto: '🚨 Attention (Dépenses un peu élevées) :',
    superaramDinheiro: 'Vos dépenses et factures ont dépassé votre argent disponible ce mois-ci de',
    recomendamosPriorizar: "Pour le moment vous avez dépensé plus que gagné. Nous vous conseillons de prioriser les factures de base et d'éviter les achats extra.",
    cuidadoPesoParcelas: '⚠️ Attention au poids des échéances :',
    parcelamentosComprometem: 'Vos paiements échelonnés engagent',
    historicoFinanceiroText: 'de votre historique financier',
    eviteNovosParcelamentos: "Trop d'achats échelonnés bloquent vos revenus futurs. Évitez les nouveaux paiements jusqu'à alléger ce pourcentage !",
